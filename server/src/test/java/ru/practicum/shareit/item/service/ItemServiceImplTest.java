...
class ItemServiceImplTest {
    ...
    @Test
    public void updateItemWithNull() {
    ...
    public void getPersonal() {
        ...
        BookingDtoLittle bookingShortDto2 = BookingMapper.toBookingShortDto(bookingDto2);
        expectedItemDto.setLastBooking(bookingShortDto);
        ...
        when(bookingRepository.findAllByOwnerAndStatus(anyLong(), any(Status.class), any(Sort.class))).thenReturn(List.of(booking));
        List<ItemDto> actualDto = itemService.getItemsByUserId(user.getId(), from, size);
        ...
        verify(bookingRepository, times(1)).findAllByOwnerAndStatus(anyLong(), any(Status.class), any(Sort.class));
    }
    ...
    public void getPersonalWithNoItems() {
        ...
        verify(bookingRepository, never()).findAllByOwnerAndStatus(anyLong(), any(Status.class), any(Sort.class));
    }
