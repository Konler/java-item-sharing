...
import ru.practicum.shareit.user.util.UserErrorResponse;
...
class UserController {
    ...
    @ExceptionHandler
    private ResponseEntity<UserErrorResponse> handleException(ValidationException e) {
        UserErrorResponse response = new UserErrorResponse("Ошибка валидации", System.currentTimeMillis());
